...
const CreateContent = memo((props) => {
    ...
    /* ボタンたち */
    const buttons = <>
        <IconButton onClick={add}><Check /></IconButton>
        <IconButton onClick={close}><Delete /></IconButton>
    </>
    ...
    if (isOpen) {
        ...
        return (
            <Button fullWidth variant="outlined" color="primary" className="addButton" onClick={() => { setIsOpen(true) }}>＋</Button>
        )
    }
